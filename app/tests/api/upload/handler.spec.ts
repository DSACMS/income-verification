...
import handler from '@/pages/api/upload'; // Adjust the import path as necessary
  ...
  return {
    ...
    default: () => ({
      parse: () => {
        ...
        const file1 = { filepath: testDocument.sourcePath, originalFilename: testDocument.fileName, mimetype: 'image/jpeg' };
        const file2 = { filepath: '/tmp/uploaded2.png', originalFilename: 'test2.png', mimetype: 'image/png' };
        ...
        results: [
          {
            status: "fulfilled",
            value: {
              imagePath: "/var/folders/g4/chfpyqbn7l74n7v9__5y4pwh0000gp/T/adp-earnings-statement1",
              isBlurry: false,
